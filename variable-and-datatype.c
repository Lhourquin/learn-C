...
int main(void){
	...
	*/
	...
	register int number = 5;//earlier when computer was not so powerful like now, the register was used to store momentaly the variable on the register, so directly on the CPU, now we have computer more powerfull amd the compiler manage that for us.
